...
const GAS_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbw2jeZKmZtNtPPuzeCcxMifKP0wooP2dne_9t72v-HazTS0lLVJRqXuGjaHBCQhn0ishA/exec"; 
...
const getInitialMockSettings = (): AppSettings => {
  const defaultSettings: AppSettings = {
    ...
    alamat: "Jl. Poros Kariango Km.3, Bontoramba, Kec. Mandai, Kab. Maros",
    telepon: "082291396693",
    email: "2uptdsdn234barambang2@gmail.com",
    ...
    koordinatSekolah: "-5.06225355255599, 119.56782811871828", // Default to Makassar
    tanggalCutoffUsia: "", // Tanggal ditetapkan cutoff usia
    sambutanKepalaSekolah: "Selamat datang di website resmi SPMB 2026. Kami berkomitmen untuk memberikan pelayanan pendidikan terbaik bagi putra-putri Anda. Mari bergabung bersama kami untuk mencetak generasi penerus bangsa yang cerdas, berakhlak mulia, dan berprestasi.",
